        ...
        if (endpoint === "/api/product-categories") {
          return [
            ...
            },
            {
              ...
              imageUrl: "https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400",
              iconName: "Bird",
              items: ["Layer Feed", "Broiler Feed", "Turkey Feed", "Game Bird Feed", "Poultry Supplements"],
              displayOrder: 3
            },
            {
              id: 4,
              ...
              imageUrl: "https://images.unsplash.com/photo-1544947950-fa07a98d237f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400",
              iconName: "Truck",
              items: ["Fencing Materials", "Water Tanks & Troughs", "Feed Buckets & Tools", "Barn Equipment", "Agricultural Tools"],
              displayOrder: 4
            }
          ];
        }
